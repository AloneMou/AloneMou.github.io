...
1、<a href="http://www.mybatis.org/spring-boot-starter/mybatis-spring-boot-autoconfigure/" rel="nofollow noreferrer" target="_blank">mybatis-spring-boot-starter 配置项手册</a>

2、<a href="https://github.com/mybatis/spring-boot-starter" rel="nofollow noreferrer" target="_blank">GitHub仓库地址，包含代码示例</a>

3、<a href="http://www.mybatis.org/mybatis-3/zh/index.html" rel="nofollow noreferrer" target="_blank">中文官方文档</a>
